    ...
    <div class="dialog-legal-accordions">
      ...
      <details class="legal-accordion">
        ...
        <div class="legal-accordion-body">
          ...
          <p><strong>3. Chat and user inputs.</strong> The AI Copilot transmits your messages to a third-party AI service (Google Gemini) for processing via a Supabase server-side function. Messages are not stored long-term by this site, but are subject to the AI provider's own data handling policies. All other text fields (notes, reflections) are session-only and are not transmitted. Do not enter personal identifying information, medication names, or sensitive health details in the chat.</p>
